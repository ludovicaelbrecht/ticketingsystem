<%@ Page Language="vb" AutoEventWireup="false" aspcompat="true" Inherits="css.producten" CodeFile="producten.aspx.vb" %>
<%@ import Namespace="System.data.sqlclient"%>
<%@ Import Namespace="System.Data" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>CSS - Computer Sales & Services - Productencatalogus</title>
			...
			<TABLE id="pagina" cellSpacing="0" cellPadding="0" width="1003" border="0">
							...
							<TR>
								<TD style="HEIGHT: 74px" align="right" width="233" background="img_bg/nav_boven.gif"
									...
									<TABLE id="login" style="WIDTH: 187px; HEIGHT: 72px" cellSpacing="0" cellPadding="0" width="187"
										...
										<tr>
											<td align="center"><asp:button id="cmdLogin" tabIndex="3" runat="server" Font-Bold="True" ForeColor="#5D5D5B" Text="Login"></asp:button></td>
											<td align="center"><asp:button id="cmdRegistreer" tabIndex="4" runat="server" Font-Bold="True" ForeColor="#5D5D5B"
													Width="76px" Text="Registreer"></asp:button></td>
										</tr>
									</TABLE>
								</TD>
							</TR>
					...
					<TD style="WIDTH: 159px; HEIGHT: 463px" vAlign="top" width="159" background="img_bg/nav_left.gif">
						<TABLE id="navlinks" cellSpacing="0" cellPadding="0" width="177" border="0">
							...
							<tr>
								<td align="left"><br>
									<font size="-1">
										<asp:label id="lblGebruikersnaam" runat="server" Font-Bold="True" Visible="False" Height="46px"
											BackColor="Transparent" Width="128px">Label</asp:label></font></td>
							</tr>
							<tr>
						...
						<TABLE id="paginainhoud" cellSpacing="0" cellPadding="0" width="792" border="0">
							<TR>
								<TD vAlign="top" align="center">
									...
									<P align="left"><b>Selecteer de categorie waaruit u artikels wilt zien:</b>&nbsp;
										<asp:dropdownlist id="DDLcategorie" runat="server"></asp:dropdownlist>&nbsp;
										<asp:button id="cmdZoekCategorie" runat="server" Font-Bold="True" Height="22px" ForeColor="#5D5D5B"
											Width="64px" Text="Zoeken" CausesValidation="False"></asp:button></P>
									<p align="center">
										<%
											call getData()
										%>
				...
				<TR>
					<%
						...
						response.write(19 + (aantalRijen * 27) & "px'></td>")
					%>
				</TR>
				<TR>
