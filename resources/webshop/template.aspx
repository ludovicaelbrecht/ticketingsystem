<%@ Page Language="vb" AutoEventWireup="false" Inherits="css.template" CodeFile="template.aspx.vb" %>
				...
				<TR>
					...
					<TD vAlign="top" width="256" background="img_bg/nav_boven.gif" height="153">
						<TABLE id="navboven" style="WIDTH: 256px; HEIGHT: 104px" cellSpacing="0" cellPadding="0"
							width="262" border="0">
							<TR>
								<TD style="HEIGHT: 74px" width="256" background="img_bg/nav_boven.gif" colSpan="3"></TD>
							</TR>
							<TR>
