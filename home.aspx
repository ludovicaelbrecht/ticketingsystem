...
<%@ Page Language="vb" AutoEventWireup="false" aspcompat="true" Inherits="css.home" CodeFile="home.aspx.vb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>CSS - Computer Sales & Services - Hoofdpagina</title>
						...
						<TABLE id="navlinks" cellSpacing="0" cellPadding="0" width="177" border="0">
							<TR>
								<TD>
									<P>&nbsp;</P>
									<P>&nbsp;</P>
									<P align="left"><asp:imagebutton id="Imgbuthome" runat="server" ImageUrl="img_nav/over/navleft_over_01.gif"></asp:imagebutton></P>
								</TD>
							</TR>
							<TR>
