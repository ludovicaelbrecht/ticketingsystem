<%@ Page Language="vb" AutoEventWireup="false" aspcompat="true" Inherits="css.promoties" CodeFile="promoties.aspx.vb" %>
<%@ import Namespace="System.data.sqlclient"%>
<%@ Import Namespace="System.Data" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>CSS - Computer Sales & Services - Promoties</title>
								...
								<TD style="HEIGHT: 74px" align="right" width="233" background="img_bg/nav_boven.gif"
									...
									<TABLE id="login" style="WIDTH: 187px; HEIGHT: 72px" cellSpacing="0" cellPadding="0" width="187"
										...
										<tr>
											...
											<td align="center">
												<asp:button id="cmdRegistreer" tabIndex="4" runat="server" Width="76px" ForeColor="#5D5D5B" Font-Bold="True" Text="Registreer"></asp:button>
											</td>
										</tr>
									</TABLE>
								</TD>
				...
				<TR>
					<TD style="WIDTH: 159px; HEIGHT: 463px" vAlign="top" width="159" background="img_bg/nav_left.gif">
						<TABLE id="navlinks" cellSpacing="0" cellPadding="0" width="177" border="0">
							...
							<TR>
								<TD><asp:imagebutton id="Imgbutpromoties" runat="server" ImageUrl="img_nav/over/navleft_over_04.gif"></asp:imagebutton></TD>
							</TR>
							<TR>
