...
<%@ Page Language="vb" AutoEventWireup="false" aspcompat="true" Inherits="css.verwijderArtikel" CodeFile="verwijderArtikel.aspx.vb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>CSS - Computer Sales & Services - Verwijderen artikel</title>
							...
							<TR>
								<TD style="HEIGHT: 74px" align="right" width="233" background="img_bg/nav_boven.gif"
									...
									<TABLE id="login" style="WIDTH: 187px; HEIGHT: 72px" cellSpacing="0" cellPadding="0" width="187"
										...
										<tr>
											<td align="center" colSpan="2"><asp:button id="cmdLogin" runat="server" Font-Bold="True" ForeColor="#5D5D5B" Text="Login"></asp:button></td>
										</tr>
									</TABLE>
								</TD>
							</TR>
						...
						<TABLE id="paginainhoud" cellSpacing="0" cellPadding="0" width="792" border="0">
							<TR>
								<TD vAlign="top" align="center">
									<H5 align="center">Verwijderen van artikel uit winkelkar...</H5>
								</TD>
							</TR>
						</TABLE>
						<P>&nbsp;</P>
